...
import { Loader2, Users, ChevronRight, UserPlus, Eye, EyeOff } from 'lucide-react'
...
export default function FansPage() {
  ...
  useEffect(() => {
    ...
    if (stored) { router.replace('/fans/rounds'); return }
    loadFans()
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-club-red text-white px-4 pt-12 pb-6">
        <div className="max-w-lg mx-auto">
          <p className="text-red-200 text-sm font-semibold uppercase tracking-widest mb-1">Keysborough District FC</p>
          <h1 className="text-2xl font-black">Fan Zone</h1>
          <p className="text-red-100 text-sm mt-1">Vote for your MOTM · Message the players</p>
        </div>
      </div>
      ...
      <main className="flex-1 px-4 py-6 max-w-lg mx-auto w-full">
            ...
            <div className="space-y-2">
              {filtered.length === 0 && (
                <p className="text-center text-gray-400 text-sm py-6">
                  {search ? 'No fans match your search.' : 'No fans registered yet. Be the first!'}
                </p>
              )}
              {filtered.map(fan => (
                <button
        ...
        {view === 'pin' && selectedFan && (
          <div className="space-y-4">
            <button onClick={() => { setView('list'); setError('') }} className="text-sm text-gray-400 hover:text-gray-600 flex items-center gap-1">
              ← Back
            </button>
            <div className="flex items-center gap-3">
        ...
        {view === 'register' && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">Create your fan profile to vote and message players.</p>
            </div>
